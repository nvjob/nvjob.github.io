...
document.oncontextmenu=function(e){return false};
    ...
    function imagevibar() {
        if (headerchecker == 0) {
            $(".astro_0").attr("src", "https://raw.githubusercontent.com/nvjob/nvrepo/master/website/nvjob/res/a0.png").bind('onreadystatechange load', on_layer_load);
            $(".astro_1").attr("src", "https://raw.githubusercontent.com/nvjob/nvrepo/master/website/nvjob/res/a1.png").bind('onreadystatechange load', on_layer_load);
            $(".astro_2").attr("src", "https://raw.githubusercontent.com/nvjob/nvrepo/master/website/nvjob/res/a2.png").bind('onreadystatechange load', on_layer_load);
            $(".astro_3").attr("src", "https://raw.githubusercontent.com/nvjob/nvrepo/master/website/nvjob/res/a3.png").bind('onreadystatechange load', on_layer_load);
            $(".astro_4").attr("src", "https://raw.githubusercontent.com/nvjob/nvrepo/master/website/nvjob/res/a4.png").bind('onreadystatechange load', on_layer_load);
        }
    }
